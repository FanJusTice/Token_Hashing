...
#define EMPTY 0b0000                      // The slot is empty or occuoied by invaild data
#define VAILD_DATA 0b0001                 // The slot is occupied by vaild data
#define QUERY_ONCE 0b0010                 // The slot is occupied by vaild data and has been queried once
#define QUERY_MORE 0b0011                 // The slot is occupied by vaild data and has benn queried twice or more times
